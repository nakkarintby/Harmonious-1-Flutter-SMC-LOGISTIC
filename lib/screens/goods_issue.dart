...
class _GoodIssueState extends State<GoodIssue> {
  ...
  Future<void> documentIDCheck() async {
    ...
    if (response.statusCode != 200) {
      showErrorDialog('Error Http Requests documentIDCheck GI');
      return;
    }
  ...
  Future<void> locationCheck() async {
    ...
    if (response.statusCode != 200) {
      showErrorDialog('Error Http Requests locationCheck GI');
      return;
    }
  ...
  Future<void> gradeCheck() async {
    ...
    if (response.statusCode != 200) {
      showErrorDialog('Error Http Requests gradeCheck GI');
      return;
    }
  ...
  Future<void> submitGI() async {
    ...
    if (response.statusCode != 200) {
      ...
      showErrorDialog('Error Http Requests submitGI1 GI');
      return;
    }
    ...
    if (data != null) {
      ...
      if (response.statusCode != 200) {
        await showProgressLoading(true);
        showErrorDialog('Error Http Requests submitGI2 GI');
        return;
      }
  ...
  Future<void> finishGI() async {
    ...
    if (response.statusCode != 200) {
      await showProgressLoading(true);
      showErrorDialog('Error Http Requests finishGI GI');
      return;
    }
